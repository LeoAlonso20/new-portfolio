...
const links = [
  {
    key: "email" as const,
    href: "mailto:leandroalonso2000@gmail.com",
    icon: (
      <svg
        width="20"
        height="20"
  ...
  },
  {
    ...
    href: "https://linkedin.com/in/leandro-alonso-work/",
    icon: (
  ...
  {
    key: "github" as const,
    href: "https://github.com/LeoAlonso20",
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
          ...
          {links.map((link) => (
            <StaggerItem key={link.key}>
              <a
                ...
                className="group h-full flex items-center gap-4 p-6 rounded-2xl border border-border-secondary hover:border-border-primary hover:bg-surface-secondary transition-all duration-300"
              >
